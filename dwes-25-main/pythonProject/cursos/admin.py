...
from .models import Categoria, Etiqueta, Instructor, Curso, Estudiante, Inscripcion, Valoracion
...
class ValoracionAdmin(admin.ModelAdmin):
    list_display = ("id", "curso", "estudiante", "puntuacion", "fecha")
    list_filter = ("curso", "puntuacion", "fecha")
    search_fields = ("curso__titulo", "estudiante__usuario__username", "estudiante__usuario__email")
    ordering = ("-fecha",)
